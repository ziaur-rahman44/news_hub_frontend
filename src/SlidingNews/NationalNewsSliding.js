        ...
        <div className='container'>
            <div className='sportN'>
                <div className="flex items-center titleSlide">
                    <div className=''>
                    <h2 className='text-2xl'>জাতীয়</h2>
                </div>
            ...
            <div className='' >
                ...
                return(
                    <div className="shadow-xl item flex-none" key={_id}>
                            <Link to={`/nationaldetails/${_id}`}>
                        <figure className="">
                            <img src={news} alt="Shoes" className=" h-36 w-auto" />
                        </figure>
                        <div className="w-60">
                            <h2 className="font-bold titles text-justify px-2 titles">{title}</h2>
...
export default NationalNewsSliding;